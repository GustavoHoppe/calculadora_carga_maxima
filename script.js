...
botaocalc.onclick = function calcular() {
    ...
    botaoHip.onclick = function mostraHip () {
        ...
        res.innerHTML += `<p class="resposta__texto">Para <strong class="resposta__strong">Hipertrofia</strong> use a carga entre <strong class="resposta__strong">${Math.round(cargaHip1)} e ${Math.round(cargaHip2)} Kg.</strong> Faça repetições entre <strong class="resposta__strong">6 e 12</strong>.</p>`;
    }
                       
    botaoRml.onclick = function mostraRml() {

        res.innerHTML += `<p class="resposta__texto">Para <strong class="resposta__strong">RML</strong> use a carga entre <strong class="resposta__strong">${Math.round(cargaRml1)} e ${Math.round(cargaRml2)} Kg.</strong> Faça repetições entre <strong class="resposta__strong">15 e 25</strong>.</p>`;
    }

    botaoFor.onclick = function mostraFor() {

        res.innerHTML += `<p class="resposta__texto">Para <strong class="resposta__strong">Força Pura</strong> use a carga entre <strong class="resposta__strong">${Math.round(cargaforca1)} e ${Math.round(cargaMaxima)} Kg.</strong> Faça repetições entre <strong class="resposta__strong">1 e 5</strong>.</p>`;
    }        
}
